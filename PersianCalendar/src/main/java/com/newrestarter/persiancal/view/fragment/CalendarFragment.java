...
import com.newrestarter.persiancal.adapter.CalendarAdapter;
import com.newrestarter.persiancal.adapter.CardTabsAdapter;
import com.newrestarter.persiancal.databinding.EventsTabContentBinding;
import com.newrestarter.persiancal.databinding.FragmentCalendarBinding;
import com.newrestarter.persiancal.databinding.OwghatTabContentBinding;
...
import com.newrestarter.persiancal.view.CalendarsView;
import com.newrestarter.persiancal.view.activity.MainActivity;
import com.newrestarter.persiancal.view.dialog.SelectDayDialog;
...
import static com.newrestarter.persiancal.Constants.CALENDAR_EVENT_ADD_MODIFY_REQUEST_CODE;
...
public class CalendarFragment extends Fragment implements View.OnClickListener {
    ...
    private void shareApplication() {
        ShareCompat.IntentBuilder.from(this.getActivity())
          .setType("text/plain")
          .setChooserTitle("اشتراک گذاری لینک دانلود توسط:")
          .setText("https://cafebazaar.ir/app/com.newrestarter.persiancal/?l=fa")
          .startChooser();
    }
