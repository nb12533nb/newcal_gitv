...
import com.newrestarter.persiancal.databinding.ActivityMainBinding;
import com.newrestarter.persiancal.service.ApplicationService;
import com.newrestarter.persiancal.util.CalendarUtils;
import com.newrestarter.persiancal.util.TypefaceUtils;
...
import com.newrestarter.persiancal.view.fragment.CalendarFragment;
import com.newrestarter.persiancal.view.fragment.CompassFragment;
import com.newrestarter.persiancal.view.fragment.ConverterFragment;
import com.newrestarter.persiancal.view.preferences.SettingsFragment;
...
import static com.newrestarter.persiancal.Constants.DEFAULT_APP_LANGUAGE;
import static com.newrestarter.persiancal.Constants.LANG_AR;
import static com.newrestarter.persiancal.Constants.LANG_EN_IR;
import static com.newrestarter.persiancal.Constants.LANG_EN_US;
import static com.newrestarter.persiancal.Constants.LANG_FA;
import static com.newrestarter.persiancal.Constants.LANG_FA_AF;
import static com.newrestarter.persiancal.Constants.LANG_PS;
import static com.newrestarter.persiancal.Constants.LANG_UR;
import static com.newrestarter.persiancal.Constants.LIGHT_THEME;
import static com.newrestarter.persiancal.Constants.PREF_APP_LANGUAGE;
import static com.newrestarter.persiancal.Constants.PREF_HOLIDAY_TYPES;
import static com.newrestarter.persiancal.Constants.PREF_MAIN_CALENDAR_KEY;
import static com.newrestarter.persiancal.Constants.PREF_NOTIFY_DATE;
import static com.newrestarter.persiancal.Constants.PREF_OTHER_CALENDARS_KEY;
import static com.newrestarter.persiancal.Constants.PREF_PERSIAN_DIGITS;
import static com.newrestarter.persiancal.Constants.PREF_SHOW_DEVICE_CALENDAR_EVENTS;
...
//      try{  getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.banner_toolbar));}catch (Exception e){}


      TapsellBannerView banner1 = findViewById(R.id.banner_main);
        banner1.loadAd(getApplicationContext(), "5e6e33c8ff074e00013b5f66", TapsellBannerType.BANNER_320x50);
...
//        }
        ...
        if (prefs.getString(PREF_APP_LANGUAGE, "N/A").equals("N/A")
            ...
            Snackbar snackbar = Snackbar.make(binding.coordinator, "✖  قصد تعویض زبان تقویم رو دارین?",
                    10000);
            ...
            snackbar.setAction("تنظیمات", view -> {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.other:
                ...
                try {
                    ...
                    intent.setData(Uri.parse("bazaar://collection?slug=by_author&aid=" + "adsiye"));
                    intent.setPackage("com.farsitel.bazaar");
                    startActivity(intent);
                }
                catch (Exception e) {}
...
//                break;
    ...
    public void contact(){
        ...
        Toast.makeText(this, "از نرم افزار های مدیریت ایمیل استفاده کنید", Toast.LENGTH_SHORT).show();
        try {
            startActivity(Intent.createChooser(i, "ارسال ایمیل "));
        } catch (android.content.ActivityNotFoundException ex) {
            Toast.makeText(this, "لطفا یکی از برنامه های مدیریت ایمیل را در گوشی خود نصب نمایید", Toast.LENGTH_SHORT).show();
        }
